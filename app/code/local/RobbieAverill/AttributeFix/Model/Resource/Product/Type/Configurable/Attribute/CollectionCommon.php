<?php
/**
 * We put the actual logic to re-order the attribute option values in a trait so it can be used
 * by multiple classes, since we need to override a configurable swatches model as well.
 * 
 * @category Mage
 * @package  RobbieAverill_AttributeFix
 * @author   Robbie Averill <robbie@averill.co.nz>
 */
trait RobbieAverill_AttributeFix_Model_Resource_Product_Type_Configurable_Attribute_CollectionCommon
{
    /**
     * Load attribute prices information
     * @see Mage_Catalog_Model_Resource_Product_Type_Configurable_Attribute_Collection::_loadPrices
     * @return self
     */
